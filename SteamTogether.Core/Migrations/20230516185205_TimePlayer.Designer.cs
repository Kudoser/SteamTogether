...
namespace SteamTogether.Core.Migrations
{
    ...
    [Migration("20230516185205_TimePlayer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteamTogether.Core.Models.PlayerGame", b =>
                {
                    b.Property<uint>("GameId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<TimeSpan>("PlaytimeForever")
                        .HasColumnType("TEXT");

                    b.Property<TimeSpan?>("PlaytimeLastTwoWeeks")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SteamTogether.Core.Models.PlayerGame", b =>
                {
                    b.HasOne("SteamTogether.Core.Models.SteamGame", "Game")
                        .WithMany("PlayerGames")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SteamTogether.Core.Models.SteamPlayer", "Player")
                        .WithMany("PlayerGames")

    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_SteamPlayerTelegramChat",
                        x => new { x.PlayerId, x.ChatId }
                    );
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "SteamPlayerTelegramChat");

            migrationBuilder.DropTable(name: "SteamPlayers");

            migrationBuilder.DropTable(name: "TelegramChat");
        }
    }
}
